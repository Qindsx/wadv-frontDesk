      ...
      series: [
        {
          ...
          // barMaxWidth: '20%',
          data: [
            props.data[0]?.whiteTea,
            props.data[0]?.greenTea,
            props.data[0]?.wulongTea,
            props.data[0]?.otherTea,
          ],
          // markPoint: {
          //   label: {
          //     position: 'left',
        ...
        },
        {
          ...
          // barMaxWidth: '20%',
          data: [
            props.data[1]?.whiteTea,
            props.data[1]?.greenTea,
            props.data[1]?.wulongTea,
            props.data[1]?.otherTea,
          ],
          // markPoint: {
          //   // markLine 也是同理
          //   label: {
